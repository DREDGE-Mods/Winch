...
case "${file_out}" in
    *PE32*)
        echo "The selected game executable is a Windows executable." >&2
        echo "Use the Windows Winch/Doorstop files when running the Windows build through Wine or Proton." >&2
        exit 1
    ;;
    *shell\ script*)
