...
public static class deepsubmergence_fishshreddershark
{
    public static Winch.Data.Item.AberrationableFishItemData deepsubmergence_fishshreddersharkInstance = (Winch.Data.Item.AberrationableFishItemData)System.Linq.Enumerable.First(ScriptableObjectInstances.ItemDatas, x => x.name == "deepsubmergence_fishshreddershark");
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<string> aberrations = deepsubmergence_fishshreddersharkInstance.aberrations;
    public static string nonAberrationParent = "";
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UnityEngine.Vector2Int> cellsExcludedFromDisplayingInfection = deepsubmergence_fishshreddersharkInstance.cellsExcludedFromDisplayingInfection;
    ...
    public static System.Decimal sellOverrideValue = 0m;
     ...
     /// </json>
    public static UnityEngine.Sprite sprite = deepsubmergence_fishshreddersharkInstance.sprite;
    ...
    public static bool isUnderlayItem = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UnityEngine.Vector2Int> dimensions = deepsubmergence_fishshreddersharkInstance.dimensions;
    ...
    public static string id = "";
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemNameKey = deepsubmergence_fishshreddersharkInstance.itemNameKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemDescriptionKey = deepsubmergence_fishshreddersharkInstance.itemDescriptionKey;
    public static bool hasAdditionalNote = false;
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString additionalNoteKey = deepsubmergence_fishshreddersharkInstance.additionalNoteKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemInsaneTitleKey = deepsubmergence_fishshreddersharkInstance.itemInsaneTitleKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemInsaneDescriptionKey = deepsubmergence_fishshreddersharkInstance.itemInsaneDescriptionKey;
    public static string linkedDialogueNode = "";
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString dialogueNodeSpecificDescription = deepsubmergence_fishshreddersharkInstance.dialogueNodeSpecificDescription;
    ...
    public static UnityEngine.Color tooltipNotesColor = new UnityEngine.Color(1f, 1f, 1f, 1f);
     ...
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite itemTypeIcon = deepsubmergence_fishshreddersharkInstance.itemTypeIcon;
     ///<json>
     /// null
     /// </json>
    ...
    public static bool availableInDemo = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<Entitlement> entitlementsRequired = deepsubmergence_fishshreddersharkInstance.entitlementsRequired;
}
