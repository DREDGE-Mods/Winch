namespace Winch.AbyssApi.GameReferences.ItemDatas.SpatialItemDatas.HarvestableItemDatas.FishItemDatas.AberrationableFishItemDatas;
public static class deepsubmergence_fishironlungfish
{
    public static Winch.Data.Item.AberrationableFishItemData deepsubmergence_fishironlungfishInstance = (Winch.Data.Item.AberrationableFishItemData)System.Linq.Enumerable.First(ScriptableObjectInstances.ItemDatas, x => x.name == "deepsubmergence_fishironlungfish");
     ///<json>
     /// {
     ///    "$content": [],
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<string> aberrations = deepsubmergence_fishironlungfishInstance.aberrations;
    public static string nonAberrationParent = "";
     ///<json>
     /// {
     ///    "$content": [
     ///        {
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UnityEngine.Vector2Int> cellsExcludedFromDisplayingInfection = deepsubmergence_fishironlungfishInstance.cellsExcludedFromDisplayingInfection;
    public static HarvestMinigameType harvestMinigameType = HarvestMinigameType.DREDGE_RADIAL;
    public static int perSpotMin = 3;
    public static int perSpotMax = 8;
    ...
    public static System.Decimal value = 46m;
    public static bool hasSellOverride = false;
    public static System.Decimal sellOverrideValue = 0m;
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite sprite = deepsubmergence_fishironlungfishInstance.sprite;
    public static UnityEngine.Color itemColor = new UnityEngine.Color(0.2313726f, 0.1490196f, 0.1333333f, 1f);
    ...
    public static bool isUnderlayItem = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<UnityEngine.Vector2Int> dimensions = deepsubmergence_fishironlungfishInstance.dimensions;
    ...
    public static string id = "";
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemNameKey = deepsubmergence_fishironlungfishInstance.itemNameKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemDescriptionKey = deepsubmergence_fishironlungfishInstance.itemDescriptionKey;
    public static bool hasAdditionalNote = false;
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString additionalNoteKey = deepsubmergence_fishironlungfishInstance.additionalNoteKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemInsaneTitleKey = deepsubmergence_fishironlungfishInstance.itemInsaneTitleKey;
     ///<json>
     /// {
     ///    "$content": [],
     ///    "$type": "UnityEngine.Localization.LocalizedString"
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString itemInsaneDescriptionKey = deepsubmergence_fishironlungfishInstance.itemInsaneDescriptionKey;
    public static string linkedDialogueNode = "";
     ...
     ///}
     ///</json>
    public static UnityEngine.Localization.LocalizedString dialogueNodeSpecificDescription = deepsubmergence_fishironlungfishInstance.dialogueNodeSpecificDescription;
    ...
    public static UnityEngine.Color tooltipTextColor = new UnityEngine.Color(0.2901961f, 0.9294118f, 0.8509804f, 1f);
    public static UnityEngine.Color tooltipNotesColor = new UnityEngine.Color(1f, 1f, 1f, 1f);
     ///<json>
     /// Serialization does not support this type.
     /// </json>
    public static UnityEngine.Sprite itemTypeIcon = deepsubmergence_fishironlungfishInstance.itemTypeIcon;
     ///<json>
     /// null
     /// </json>
    ...
    public static bool availableInDemo = false;
     ...
     ///}
     ///</json>
    public static System.Collections.Generic.List<Entitlement> entitlementsRequired = deepsubmergence_fishironlungfishInstance.entitlementsRequired;
}
