...
namespace FullSerializer {
    internal static class fsJsonPrinter {
        /// <summary>
        ...
        internal static void PrettyJson(fsData data, TextWriter outputStream) {
        ...
        /// </summary>
        internal static string PrettyJson(fsData data) {
        ...
        /// <param name="data">The data to print.</param>
        /// <param name="outputStream">Where to write the printed data.</param>
        internal static void CompressedJson(fsData data, StreamWriter outputStream) {
        ...
        /// </summary>
        internal static string CompressedJson(fsData data) {
            var sb = new StringBuilder();
            using (var writer = new StringWriter(sb)) {
