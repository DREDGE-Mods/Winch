...
namespace FullSerializer {
    partial class fsConverterRegistrar {
        internal static Internal.DirectConverters.RectOffset_DirectConverter Register_RectOffset_DirectConverter;
    }
}

namespace FullSerializer.Internal.DirectConverters {
    internal class RectOffset_DirectConverter : fsDirectConverter<RectOffset> {
