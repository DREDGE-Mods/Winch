...
namespace FullSerializer {
    partial class fsConverterRegistrar {
        internal static Internal.DirectConverters.GUIStyleState_DirectConverter Register_GUIStyleState_DirectConverter;
    }
}

namespace FullSerializer.Internal.DirectConverters {
    internal class GUIStyleState_DirectConverter : fsDirectConverter<GUIStyleState> {
