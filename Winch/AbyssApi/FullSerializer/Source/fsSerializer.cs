...
namespace FullSerializer {
    internal class fsSerializer {
        ...
        /// </summary>
        internal void RemoveProcessor<TProcessor>() {
            int i = 0;
        ...
        /// </summary>
        internal fsResult TrySerialize<T>(T instance, out fsData data) {
        ...
        /// </summary>
        internal fsResult TryDeserialize<T>(fsData data, ref T instance) {
        ...
        internal fsResult TrySerialize(Type storageType, object instance, out fsData data) {
        ...
        /// <param name="data">The serialized state of the object.</param>
        /// <returns>If serialization was successful.</returns>
        internal fsResult TrySerialize(Type storageType, Type overrideConverterType, object instance, out fsData data) {
        ...
        /// </summary>
        internal fsResult TryDeserialize(fsData data, Type storageType, ref object result) {
        ...
        /// Attempts to deserialize a value from a serialized state.
        /// </summary>
        internal fsResult TryDeserialize(fsData data, Type storageType, Type overrideConverterType, ref object result) {
            if (data.IsNull) {
                result = null;
