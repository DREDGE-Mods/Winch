...
namespace FullSerializer {
    ...
    internal struct fsResult {
        ...
        /// A successful result.
        /// </summary>
        internal static fsResult Success = new fsResult {
            _success = true
        };
        ...
        /// </summary>
        internal fsResult AssertSuccess() {
        ...
        /// asserts are false.
        /// </summary>
        internal fsResult AssertSuccessWithoutWarnings() {
        ...
        internal IEnumerable<string> RawMessages {
            get {
                if (_messages != null) {
                    return _messages;
                }
        ...
        internal string FormattedMessages {
            get {
                return string.Join(",\n", RawMessages.ToArray());
            }
        }
