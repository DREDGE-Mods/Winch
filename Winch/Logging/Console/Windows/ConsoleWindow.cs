...
namespace UnityInjector.ConsoleUtil
{
	internal class ConsoleWindow
	{
		...
		public static void Attach()
		{
			...
			if (OriginalStdoutHandle != IntPtr.Zero && BepInEx.ConsoleManager.ConfigConsoleOutRedirectType == BepInEx.ConsoleManager.ConsoleOutRedirectType.ConsoleOut)
		...
		private static void Initialize()
		{
			...
			setForeground = (Marshal.GetDelegateForFunctionPointer(GetProcAddress(user32Dll, "SetForegroundWindow"), typeof(SetForegroundWindowDelegate)) as SetForegroundWindowDelegate)!;
			getForeground = (Marshal.GetDelegateForFunctionPointer(GetProcAddress(user32Dll,"GetForegroundWindow"), typeof(GetForegroundWindowDelegate)) as GetForegroundWindowDelegate)!;
			getSystemMenu = (Marshal.GetDelegateForFunctionPointer(GetProcAddress(user32Dll,"GetSystemMenu"), typeof(GetSystemMenuDelegate)) as GetSystemMenuDelegate)!;
			deleteMenu = (Marshal.GetDelegateForFunctionPointer(GetProcAddress(user32Dll,"DeleteMenu"), typeof(DeleteMenuDelegate)) as DeleteMenuDelegate)!;
		}
